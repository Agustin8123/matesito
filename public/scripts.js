            ...
            if (groups.length === 0) {
                ...
                groups.forEach(group => {
                    ...
                    <div id="${menuId}" class="dropdown-menu" style="position: absolute; left: 188px; top: -20px; display: none;">
                        ...
                        <input type="radio" id="details-${groupId}v" name="nav-${groupId}" style="display:none;" onclick="toggleDetails('details-${menuId}', ${groupId})">
            ...
            if (groups.length === 0) {
                ...
                groups.forEach(group => {
                    ...
                    <div id="menu-${groupId}" class="dropdown-menu" style="position: absolute; left: 188px; top: -20px; display: none;">
                        ...
                        <input type="radio" id="details-${groupId}b" name="nav" style="display:none;" onclick="toggleDetails('details-${groupId}')">
